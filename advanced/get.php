...
$query_get = "SELECT Nickname, Score, FIND_IN_SET( Score, ( SELECT GROUP_CONCAT( DISTINCT Score ORDER BY Score DESC ) FROM MM_ADVANCED) ) AS rank FROM MM_ADVANCED ORDER BY rank ASC LIMIT 10;";
