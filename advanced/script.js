...
console.log("0 - red, 1 - orange, 2 - yellow, 3 - blue, 4 - green, 5 - brown, 6 - pink, 7- light blue");
console.log(arr);
...
var code = [undefined, undefined, undefined, undefined, undefined];

//warunki sprawdzajace, czy guzik "sprawdzam" moze juz byc odblokowany
if ((code[0] == undefined) || (code[1] == undefined) || (code[2] == undefined) || (code[3] == undefined) || (code[4] == undefined)) {
...
//tablica kolorow
var colors = ["red", "orange", "yellow", "blue", "green", "#512A09", "deeppink", "deepskyblue"];
...
for (var level = 1; level <= 8; level++) {
    ...
    (function () {
        ...
        //metoda .data() użyta by przypisac kolejne wartosci dla level
        $(".board .level" + level + " .request .socketBig:nth-child(5)").data("level", level);

        //zmieniam kolor w sockecie nr 1 za pomoca LPP
        $(".board .level" + level + " .request .socketBig:nth-child(5)").on("click", function () {



            if ($(this).data("level") == levelCounter) {

                //pozycja 4 w tablicy kodu proponowanego przez gracza
                codeCounter = 4;
        ...
        //zmiana kolorow/symboli na prawym przekliku
        $(".level" + level + " .request .socketBig:nth-child(5)").on("contextmenu", function (event) {
            //usuwam domyslne contextmenu po kliknieciu PPM
            event.preventDefault();
